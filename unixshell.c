...
void readUserCmd(char *args[], int *hasAmp, int *argv) {
        ...
        *hasAmp = 0;
        ...
        // assign the last variables is NULL
        args[*argv] = NULL;
}
                        ...
                        if (argv == 0) {
                                ...
                                for (int i = 1; i <= argv - 1; i++) {
                                        ...
                                        if (strcmp(args[i], "<") == 0) {
                                                ...
                                                // Sperate 2 commands, and run 2 commands in order
